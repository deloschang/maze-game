...
int main(int argc,char* argv[]){
    ...
    if (avatar_id==0){
        ...
        /*// This creates a new thread for the graphics which cannot run */
        /*// on the same thread */
        /*pthread_t t1;*/
    ...
    // Set the difficulty for the maze
    ...
    while (condition){ 
        ...
        if (turn_num==avatar_id){//only making a move if it's avatar's turn
            ...
            // After we update our shared map and finish everything else
            // Release the semaphore so other processes can access the 
            ...
            // In case it wasn't avatar's turn to move
            // Still listening to the server to extract the ID
            if (recv(sockfd,recvline,sizeof(AM_MESSAGE),0)==0){
    ...
    void update_graphics(){
        ...
        /*for (int i = 0; i < graphics_map->row; i++){*/
          /*for (int j = 0; j < graphics_map->column; j++){*/
            ...
            /*// For fixed Level 0 mazes graphics*/
            /*// Only parse for avatars*/
            /*if (data2[i][j] == 'A'){*/
                /*data2[i][j] = 'E';*/
            /*}*/
          /*}*/
